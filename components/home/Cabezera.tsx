...
function Cabezera({ titulo, descripcion }: cabezeraProps) {
  ...
  return (
    <div>
      <div className="w-full h-screen bg-fixed bg-[url('/images/mimo.jpg')] bg-[center_-10rem] bg-cover px-40 flex items-center max-2xl:bg-[center_top_0rem] max-[500px]:px-10">
        <div>
