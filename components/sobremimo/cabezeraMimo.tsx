...
function CabezeraMimo({ titulo, descripcion, imagen }: cabezeraMimoProps) {
  return (
    <div>
      <div className="w-full h-screen bg-fixed bg-[url('/images/mimo.jpg')] bg-[center_-10rem] bg-cover flex items-start justify-center py-10 max-2xl:bg-[center_top_0rem] max-xl:py:5">
        <div className="">
